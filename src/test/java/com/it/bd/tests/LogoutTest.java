...
public class LogoutTest extends CommonMethods{
	...
	public void openUrl() throws InterruptedException {
		...
		parentTest = report.createTest("<p style=\"color:#FF6000; font-size:20px\"><b>Logout</b></p>").assignAuthor("QA TEAM").assignDevice("Windows");
	}
	
	
	@Test 
	public void testLogoutMethod() throws IOException {
		//System.out.println(PageDriver.getCurrentDriver().getTitle());
		childTest = parentTest.createNode("<p style=\"color:#3E96E7; font-size:20px\"><b>Logout Successfully</b></p>");
